...
<title>SzabistCarpool - CarpoolRequests</title>
				...
				<div class="container">
					...
					<nav role="navigation" class="breadcrumbs">
						<ul>
							...
							<li><a href="http://localhost:8080/SZABIST_CarpoolApplication/LogoutController">Logout</a></li>
						</ul>
					</nav>
				</div>
			</div>
...
<table class="table table-striped table-hover table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>Passenger Soucre Location</th>
				 <th>Mobile No</th>
		...
		<c:forEach items="${CarpoolRequests}" var="requests">
		<tr>
		<%-- <td><c:out value="${requests.requestsId}"/></td> --%>
		<td><c:out value="${requests.name}"/></td>
		<td><c:out value="${requests.sourcelocation}"/></td>
		<td><c:out value="${requests.mobileno}"/></td>
		
	<%-- 	<td><c:out value="${requests.requestsid}"></c:out></td> --%>
		<%-- <td><a href="#"><%=session.getAttribute("SourceLocation")%></td>  --%>
		<%-- <td><a href="#"><%=session.getAttribute("UserName")%></a></td> --%>
		<!-- <th><a href="#"><input type="Submit" class="btn grey small"  value="Accept Request"></a></th> -->
		<th><a href="acceptrequest?requestsId=${requests.fk_booked_userid}"><input type="Submit" class="btn grey small"  value="Accept Request"></a></th>
		<th><a href="ride/discussion"><input type="button" class="btn grey small" value="Reject Request"></a></th>
		</tr></c:forEach>
...
<!-- Footer -->
	...
	function getPassengerId(PassengerId){
		alert(PassengerId);
	}
	</script>
